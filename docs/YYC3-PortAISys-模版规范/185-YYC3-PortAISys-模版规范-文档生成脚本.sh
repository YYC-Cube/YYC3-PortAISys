...
# @Desc: YYC3-PortAISys 全文档架构一键生成脚本 | 生成根目录docs/ | 无任何错误
import os
import sys
...
MAIN_MD_TEMPLATE = """---
@file: {FILE_NAME}
@description: YYC3-PortAISys {DESCRIPTION}
@author: YanYuCloudCube Team
@version: {VERSION}
@created: {CREATE_DATE}
@updated: {CREATE_DATE}
...
本文档详细描述YYC3-YYC3-PortAISys-{DOC_CATEGORY}-{DOC_NAME}相关内容，确保项目按照YYC³标准规范进行开发和实施。
...
README_MD_TEMPLATE = """---
@file: YYC3-PortAISys-{DOC_CATEGORY}-文档索引.md
@description: YYC3-PortAISys {DESCRIPTION}
@author: YYC³
@version: {VERSION}
@created: {CREATE_DATE}
...
本文档详细描述YYC3-PortAISys项目的文档索引模版相关内容，确保项目按照YYC³标准规范进行开发和实施。
...
def generate_project():
    """一键生成全部文档架构"""
    print("✅ 开始生成 YYC3-PortAISys 文档架构 | 根目录: {} | 编码: {}".format(DOC_ROOT, ENCODING))
    print("="*80)
    # 创建根目录
    create_dir(DOC_ROOT)
    ...
    for doc_category, doc_list in PROJECT_STRUCT.items():
        ...
        for doc_no, doc_name, doc_desc, doc_tags in doc_list:
            # 拼接文件名和标题
            file_name = "{}-YYC3-PortAISys-{}-{}.md".format(doc_no, doc_category, doc_name)
            file_path = os.path.join(cate_dir, file_name)
            title = "{}-YYC3-PortAISys-{}-{}".format(doc_no, doc_category, doc_name)
    ...
    print("✅ 所有文档严格遵循 YYC3-PortAISys 命名规范与模板标准！")
